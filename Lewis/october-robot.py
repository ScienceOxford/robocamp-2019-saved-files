...
music.play(music.PRELUDE, pin=pin14)

radio.config(channel=15, group=1, queue=1)
radio.on()
...
while True:
    switch = pin15.read_digital()  # this is your new line!!
    ...
    count += 1
    if count >= 10000:
        music.play(music.CHASE, pin=pin14, wait=False)
        count = 0
